...
namespace Negri.Wot
{
    internal class Program
    {
        ...
        private static int Main(string[] args)
        {
            ...
            //    ParseParams(args, out int ageHours, out int maxClans, out int maxRunMinutes, out bool noSaveOnDatabase,
            ...
            //    {
            //        //var toAdd = fetcher.GetClans(autoMinNumberOfMembers)
            //        //    .Where(c => !provider.ClanExists(c.ClanId))
            //        //    .OrderByDescending(c => c.AllMembersCount).ThenBy(c => c.ClanId).ToArray();

            //        //foreach (var c in toAdd.Take(maxToAutoAdd))
            //        //{
            //        //    recorder.Add(c);
            //        //    mailSender.Send($"Adicionado automaticamente o clã {c.ClanTag}",
            ...
            //    {
            //        var disbandedClan = provider.GetClan(clan.Platform, clan.ClanId);
            //        if (saveOnDatabase)
            //        {
            //            recorder.DisableClan(disbandedClan.Platform, disbandedClan.ClanId, DisabledReason.Disbanded);
        ...
        private static void ParseParams(string[] args, out int ageHours, out int maxClans, out int maxRunMinutes,
